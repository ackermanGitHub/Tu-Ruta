...
type NavigationMenuParams = {
    navigationAnimValueRef: Animated.Value,
    toggleNavMenu: () => void,
...
const NavigationMenu: React.FC<NavigationMenuParams> = ({ navigationAnimValueRef, toggleNavMenu, addMarkerHandler, openUserProfileHandler, taxiBtnHandler }) => {
